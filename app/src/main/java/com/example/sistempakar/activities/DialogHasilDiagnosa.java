...
import com.example.sistempakar.models.Kerusakan;
...
public class DialogHasilDiagnosa extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView textNamaKerusakan = view.findViewById(R.id.text_dialog_jenis_kerusakan);
        ImageView imageKerusakan = view.findViewById(R.id.image_dialog_jenis_kerusakan);
        Button buttonDetail = view.findViewById(R.id.button_detail_kerusakan);
        ...
        buttonDetail.setOnClickListener(v -> onButtonPress(kodeKerusakan));
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if(context instanceof OnFragmentInteraction){
            ...
            throw new RuntimeException(context + " must implement OnFragmentInteraction");
        }
    }
